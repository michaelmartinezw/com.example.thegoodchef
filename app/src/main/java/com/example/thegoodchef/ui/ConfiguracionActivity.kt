...
import com.example.thegoodchef.databinding.ConfiguracionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            aboutLayout.setOnClickListener {
                val openBottomSheet: AcercaFragment =
                    AcercaFragment().newInstance()
                openBottomSheet.show(supportFragmentManager, AcercaFragment.TAG)
            }

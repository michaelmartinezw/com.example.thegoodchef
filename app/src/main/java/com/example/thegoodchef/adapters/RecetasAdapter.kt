...
import com.example.thegoodchef.databinding.ContenderoRecetasBinding
...
) : RecyclerView.Adapter<RecetasAdapter.RecipeViewHolder>() {

    private var recipes = emptyList<Result>()

    class RecipeViewHolder(private val binding: ContenderoRecetasBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): RecipeViewHolder {
                ...
                val binding = ContenderoRecetasBinding.inflate(layoutInflater, parent, false)
